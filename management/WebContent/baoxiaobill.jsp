        ...
        <div class="panel panel-default">
            ...
            <div class="table-responsive">
				...
				<table>
					<tbody>
					 <tr>
			             <td colspan="1" style="position:absolute;top: 50%;left: 50%;transform:translate(-50%,-50%);">
			                    <c:choose>
			                       <c:when test="${totalpage==1 }">
			                         </c:when>
			                          <c:when test="${pagenow==1}">
			                                <a href="myBaoxiaoBill?pagenow=${pagenow+1}">下一页</a>
			                                <a href="myBaoxiaoBill?pagenow=${totalpage}">尾页</a>
			                            </c:when>
			                            <c:when test="${pagenow==totalpage }">
			                                <a href="myBaoxiaoBill?pagenow=1">首页</a>
			                                <a href="myBaoxiaoBill?pagenow=${pagenow-1}">上一页</a>
			                            </c:when>
